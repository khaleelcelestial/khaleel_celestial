...
def create_task_list_skill(user_request: str, requirements: str) -> list[str]:
    """
    Generate concrete implementation tasks from requirements.
    ...
    system_prompt = """You are a technical project manager. Given a user request and requirements, generate a list of concrete implementation tasks.

Output ONLY a JSON array of task strings, like:
["Create user authentication", "Design expense schema", "Build dashboard page"]

Each task should be:
- Concrete and actionable
- Specific to the domain (use actual feature names, not generic placeholders)
